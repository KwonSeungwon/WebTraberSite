	...
	<tbody style="text-align:left;">
		...
		<c:forEach var="fe" items="${requestScope.list}">
			<tr>
				...
				<td><a href ="delete_hugi.do?del_post_number=${fe.post_number}">삭제 </a></td>
           		<td><a href ="find_hugi.do?find_post_number=${fe.post_number}">수정 </a></td>
           		</c:if>
			</tr>
		</c:forEach>
...
<form action="/AcodaProject/post_board/search_hugi.do" method="get">
	<input name="search_post_board_hugi" type="text" id="search_post_board_hugi"/>
