...
public interface IPost_Board {
   ...
   String find_post="select post_number,title,id,post_title,post_contents,registration_date,views,path from post_board post_board,member member where post_board.user_number=member.user_number and post_board.post_number=?";
