...
%>
<form action="/AcodaProject/post_board/update_hugi.do" method="POST" enctype="multipart/form-data" id = "fileupform">
후기게시판 게시글수정<br><br>
...
파일 바꾸기 : <input type = "file" id = "picbu" name = "fileup"> <input type = "button" value = "업로드하기" class = "pbtn"><br> 
<input type="text" name="path" class = "location" value = "${find.path}"/> 
