...
public class ProductServlet {
	...
	public ModelAndView Product_Insert(ProductVO vo) throws IOException {
	...
	//사진업로드 AJAX 
	@RequestMapping(value = "/picup.do")
	public String Product_Select(MultipartHttpServletRequest uploadFile,Model m) {
		String result = "";
		...
		while(files.hasNext()) {
			...
			String f_realname = mult.getOriginalFilename();
