...
public class ProductVO {
	...
	//모든 매개변수를 가진 생성자
	public ProductVO(int item_number, String product_name, int user_number, int price, int head_count,
			String sell_date, String schedule, String trip_date, String note) {
		super();
		this.item_number = item_number;
		this.product_name = product_name;
		this.user_number = user_number;
